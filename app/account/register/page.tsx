...
export default function RegisterPage() {
  ...
  return (
    <div className="bg-gray-300 rounded-xl flex items-start justify-center pt-5 px-2 pb-4">
      <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-5">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-6 underline">Create Your Account</h1>
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full border rounded-md px-3 py-2"
                  placeholder="/images/seller1.jpg"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full border rounded-md px-3 py-2"
                  placeholder="Tell something about your craft..."
                  required
                />
              </div>
